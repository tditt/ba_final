...
def run_test():
    ...
    verify_k_vector(y2, k, sort, q, m, 1, 5000)
    verify_k_vector(y2, k, sort, q, m, 5687, 8888)
    verify_k_vector(y2, k, sort, q, m, 1256, 1999)
    verify_k_vector(y2, k, sort, q, m, 2122, 7541)
    verify_k_vector(y2, k, sort, q, m, 5522, 5566)
    verify_k_vector(y2, k, sort, q, m, 3358, 7894)
    verify_k_vector(y2, k, sort, q, m, 5, 120)
    verify_k_vector(y2, k, sort, q, m, 1000, 1005)
