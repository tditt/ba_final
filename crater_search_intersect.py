...
import util
from crater_search_util import add_ids_to_db
...
def exclusion_by_intersection_abs(boxes, km_pp, r_tol, d_tol, wmax, verb=False):
...
def do_final_validation():
    ...
    pdb.check_intersect_db(intersect_db)
    if not relative_search:
